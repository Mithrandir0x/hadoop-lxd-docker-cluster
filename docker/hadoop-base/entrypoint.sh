...
echo "export SPARK_DIST_CLASSPATH=$(hadoop --config $HADOOP_CONF_DIR classpath)" >> /etc/environment
echo "export SPARK_DIST_CLASSPATH=$(hadoop --config $HADOOP_CONF_DIR classpath)" >> /etc/bash.bashrc
